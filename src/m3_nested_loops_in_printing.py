...
def run_test_rectangle_of_stars():
    ...
    print('Test 3 of rectangle_of_stars: (1, 2)')
    rectangle_of_stars(1, 2)

    print('Test 3 of rectangle_of_stars: (10, 10)')
    rectangle_of_stars(10, 10)
...
def run_test_triangle_of_stars():
    ...
    print('Test 4 of triangle_of_stars: (10)')
    triangle_of_stars(10)

    print('Test 4 of triangle_of_stars: (2)')
    triangle_of_stars(2)
